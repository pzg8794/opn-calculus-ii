...
Drive source: https://drive.google.com/drive/folders/1Wm9apCxcGH019Uwhn6QyZgfRyUBZbK8O
...
- `.gitignore` (file)
- `200px-Similar_triangles_for_cone.svg.png` (file)
- `Calculus.docx` (file)
- `CalculusII-Formulas.docx` (file)
